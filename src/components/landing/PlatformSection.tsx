  ...
  return (
    <section id="platform" className="py-32 relative overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          {/* Left — module list */}
          <div className="lg:w-[420px] shrink-0 border-r border-white/[0.06] max-h-[520px] overflow-y-auto scrollbar-thin">
            {modules.map((mod, i) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-5 py-3.5 text-left transition-all duration-200 border-b border-white/[0.04] relative group ${
                    isActive
                      ? "bg-primary/[0.08]"
                      : "hover:bg-white/[0.03]"
                  }`}
          ...
          <div className="flex-1 p-8 lg:p-12 flex items-center justify-center min-h-[320px] lg:min-h-[520px]">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <span className="font-mono text-xs tracking-[0.15em] uppercase text-primary/70 mb-2 block">
                  {active.tag}
                </span>
